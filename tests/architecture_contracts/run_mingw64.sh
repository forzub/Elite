...
"${PYTHON_BIN}" "${ROOT_DIR}/tests/architecture_contracts/check_test_suite_source_integrity.py"
...
"${PYTHON_BIN}" "${ROOT_DIR}/tests/architecture_contracts/check_model_asset_editor_view_state.py"
