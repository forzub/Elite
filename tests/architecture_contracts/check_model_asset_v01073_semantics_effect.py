...
print('[PASS] Model Asset Editor v0.10.73 wave7E SEMANTICS effect extraction preserved under v0.10.75: 51 owned functions moved; initial tab render is projection-only; inline named functions=212')
