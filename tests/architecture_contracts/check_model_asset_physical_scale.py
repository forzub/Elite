...
for token in (
    ...
    if token not in session:
        raise AssertionError(f"schema-17 physical scale graph missing {token!r}")
...
print("[PASS] model asset editor v0.10.64 authoring-space scale / metric BUILD copy / SI physics")
