...
if 'ModelAssetEditorVersion = "0.10.67"' not in text("tools/model_asset_editor/EditorVersion.h"):
    raise AssertionError("editor version is not 0.10.67")

print("[PASS] model asset editor v0.10.67 stage certification / confirmed SOURCE deletion")
