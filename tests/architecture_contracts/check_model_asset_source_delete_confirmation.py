...
if 'ModelAssetEditorVersion = "0.10.62"' not in text("tools/model_asset_editor/EditorVersion.h"):
    raise AssertionError("editor version is not 0.10.62")

print("[PASS] model asset editor v0.10.62 stage certification / confirmed SOURCE deletion")
