...
)
{
    ...
    if (&sourceRuntime == this && sourceModuleId == targetModuleId)
    {
        ...
        sourceFragment->linearVelocity = glm::vec3(0.0f);
        sourceFragment->angularVelocity = glm::vec3(0.0f);
    ...
    claimed.linearVelocity = glm::vec3(0.0f);
    claimed.angularVelocity = glm::vec3(0.0f);
