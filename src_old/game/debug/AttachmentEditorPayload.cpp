...
namespace
{
    static std::string attachmentKindToString(ShipAttachmentKind kind)
    {
        switch (kind)
        {
            ...
            case ShipAttachmentKind::DroneLaunch: return "DroneLaunch";
            case ShipAttachmentKind::DroneRecovery: return "DroneRecovery";
            case ShipAttachmentKind::RepairWorkPoint: return "RepairWorkPoint";
            case ShipAttachmentKind::EquipmentMount: return "EquipmentMount";
